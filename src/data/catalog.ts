...
export const INGREDIENTS: Ingredient[] = [
  ...
  I('dinde', 'Dinde', 'frais', 'g', 300, { animal: 'meat' }),
  I('porc', 'Porc', 'frais', 'g', 400, { animal: 'pork' }),
  I('saucisses', 'Saucisses', 'frais', 'pc', 4, { animal: 'pork' }),
  I('agneau', 'Agneau', 'frais', 'g', 400, { animal: 'meat' }),
  I('poisson_blanc', 'Poisson blanc', 'frais', 'g', 300, { animal: 'fish' }),
  I('saumon_fume', 'Saumon fumé', 'frais', 'g', 100, { animal: 'fish' }),
  ...
  I('haricots_blancs', 'Haricots blancs', 'epicerie', 'g', 400),
  I('quinoa', 'Quinoa', 'epicerie', 'g', 500),
  I('boulgour', 'Boulgour', 'epicerie', 'g', 500, { allergens: ['Gluten'] }),
  I('sardines', 'Sardines', 'epicerie', 'g', 135, { animal: 'fish' }),
  I('olives', 'Olives', 'epicerie', 'g', 150),
  I('pate_feuilletee', 'Pâte feuilletée', 'epicerie', 'pc', 1, { animal: 'dairy', allergens: ['Gluten', 'Lactose'] }),
  I('noix', 'Noix', 'epicerie', 'g', 100, { allergens: ['Fruits à coque'] }),
