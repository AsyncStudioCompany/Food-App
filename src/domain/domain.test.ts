...
describe('search', () => {
  const ranked = rankAll(RECIPES, { fridge: {}, prefs: { diet: 'Tout', allergies: [], cuisines: [], portions: 2, ai: true, goal: 'Équilibré', onboarded: true, location: null, avoid: [] }, byId, today: '2026-09-23' })
